...
#' upasv2x_rev81_header_raw <- fread_ast_header(upasv2x_rev81_file)
#' upasv2x_rev81_header_wide <- transpose_ast_header(upasv2x_rev81_header_raw)
...
#' upasv2x_rev117_header_raw <- fread_ast_header(upasv2x_rev117_file)
#' upasv2x_rev117_header_wide <- transpose_ast_header(upasv2x_rev117_header_raw)
...
#' upasv2x_rev110_diag_header_raw <- fread_ast_header(upasv2x_rev110_diag_file)
#' upasv2x_rev110_diag_header_wide <- transpose_ast_header(upasv2x_rev110_diag_header_raw)
...
#' upasv2x_rev157_header_raw <- fread_ast_header(upasv2x_rev157_file)
#' upasv2x_rev157_header_wide <- transpose_ast_header(upasv2x_rev157_header_raw)
...
#' upasv2x_rev158_diag_header_raw <- fread_ast_header(upasv2x_rev158_diag_file)
