#' Example of raw logfile data from UPASv2x air sampler.
#'
#' A dataset containing sample information from an example UPASv2x file
#'
#' @format A data frame with 76 rows and 122 variables:
#' \describe{
...
#' Example unformatted header data from UPASv2x air sampler.
#'
#' A dataset containing sample information from an example UPASv2x file
#'
...
#' Example unformatted log data from UPASv2x air sampler.
#'
#' A dataset containing sample information from an example UPASv2x file
#'
#' @format A data frame with 12 rows and 122 variables:
#' \describe{
#'   \item{price}{price in US dollars (\$326--\$18,823)}
#'   \item{carat}{weight of the diamond (0.2--5.01)}
#'   \item{cut}{quality of the cut (Fair, Good, Very Good, Premium, Ideal)}
