...
Use the `format_hhb_sample_log()` function to convert sample log data associated with pumped samples to a long format that is helpful for looking at sample flow rates over time. 
