...
The goal of astr is to make it easy to work with log files from Access Sensor Technologies (AST) air samplers, like the Ultrasonic Personal Air Sampler (UPAS), in R.
